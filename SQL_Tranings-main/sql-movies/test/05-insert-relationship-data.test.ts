...
const insertMovieGenres = (
  ...
  var filtered = genreRows.filter((row) => genres.includes(row.genre));
  return (
...
const insertMovieActors = (
  ...
  var filtered = actorRows.filter((row) => actors.includes(row.full_name));
  return (
...
const insertMovieDirectors = (
  ...
  var filtered = directorRows.filter((row) => directors.includes(row.full_name));
  return (
...
const insertMovieKeywords = (
  ...
  var filtered = keywordRows.filter((row) => keywords.includes(row.keyword));
  return (
...
const insertMovieProductionCompanies = (
  ...
  var filtered = productionCompanyRows.filter((row) => productionCompanies.includes(row.company_name));
  return (
